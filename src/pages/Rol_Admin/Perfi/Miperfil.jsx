      ...
      <div className={`mp-stage${panelOpen ? ' mp-stage--open' : ''}`}>
        ...
        <aside className="mp-sidebar">
          ...
          <div className="mp-avatar-wrap">
            ...
            {panelOpen && (
              <div className="mp-cam-badge" onClick={(e) => { e.stopPropagation(); inputFotoRef.current?.click(); }}>
                <CameraIcon />
              </div>
            )}
          </div>
          ...
          <button className="mp-logout" onClick={logout} type="button">
            <LogoutIcon />
            Cerrar sesión
          </button>
        </aside>

        {/* Panel Deslizable / Contenedor de Formularios */}
        <div className={`mp-panel${panelOpen ? ' mp-panel--visible' : ''}`}>
          ...
          {tab === 'info' && (
            <form className="mp-form" onSubmit={handleSave}>
              ...
              {/* ZONA DE FOTO REDISEÑADA INTEGRALMENTE */}
              <div className="mp-photo-zone" onClick={() => inputFotoRef.current?.click()}>
                <div className="mp-photo-preview-container">
                  {fotoSrc
                    ? <img src={fotoSrc} alt="preview" className="mp-photo-circular-img" />
                    : <div className="mp-photo-initials">{getInitials(form.nombre, form.apellido)}</div>
                  }
                </div>
              ...
              <div className="mp-form-row">
                ...
                <div className="mp-field">
                  ...
                  <input id="apellido" name="apellido" value={form.apellido} onChange={handleChange} placeholder="Tu apellido" />
                </div>
              </div>
              ...
              <div className="mp-field">
                ...
                <div className="mp-input-locked">
                  <div className="mp-lock-left-group">
              ...
              <div className="mp-field">
                ...
                <input id="telefono" type="tel" name="telefono" value={form.telefono} onChange={handleChange} placeholder="+57 310 123 4567" />
              </div>

              <div className="mp-field">
                <label htmlFor="observaciones">Observaciones</label>
                <textarea id="observaciones" name="observaciones" rows={3} value={form.observaciones} onChange={handleChange} placeholder="Notas adicionales..." />
              </div>
          ...
          {tab === 'seguridad' && (
            <form className="mp-form" onSubmit={handleChangePw}>
              ...
              <div className="mp-field">
                ...
                <input id="passwordActual" type="password" name="passwordActual" autoComplete="current-password" value={pwForm.passwordActual} onChange={handlePwChange} placeholder="••••••••" required />
              </div>

              <div className="mp-field">
                <label htmlFor="passwordNueva">Nueva contraseña</label>
                <input id="passwordNueva" type="password" name="passwordNueva" autoComplete="new-password" value={pwForm.passwordNueva} onChange={handlePwChange} placeholder="••••••••" required />
                <PasswordStrength password={pwForm.passwordNueva} />
              </div>

              <div className="mp-field">
                <label htmlFor="passwordConfirm">Confirmar nueva contraseña</label>
                <input id="passwordConfirm" type="password" name="passwordConfirm" autoComplete="new-password" value={pwForm.passwordConfirm} onChange={handlePwChange} placeholder="••••••••" required />
              </div>
