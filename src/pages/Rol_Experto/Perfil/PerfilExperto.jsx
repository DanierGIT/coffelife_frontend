...
import '../../Rol_Admin/Perfi/miperfil.css'
...
export default function PerfilExperto({ onNavigate }) {
  ...
  const displayName = `${data.nombre} ${data.apellido}`.trim() || data.correo || 'Experto'
      ...
      <div className="mp-top animate-left">
        ...
        <div className="mp-top-content">
          ...
          <div className="mp-top-info">
            ...
            <span className="mp-role-pill">Experto Agrónomo</span>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSaveInfo}>
              <div className="mp-fields">
                ...
                <div className="mp-field">
                  ...
                  <p className="mp-field-val mp-field-val--badge">Experto Agrónomo</p>
                </div>
